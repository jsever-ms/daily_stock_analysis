...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "operation_plan_heading": "当前操作计划",
        "key_price_and_risk_reward_heading": "关键价位与风险收益",
        "key_price_heading": "关键价位",
        "trend_technical_heading": "技术与量价",
        "fundamentals_heading": "基本面估值",
        "capital_volume_heading": "资金与量价",
        "news_events_heading": "新闻/公告/催化与风险",
        "observation_zone_label": "观察区（仅跟踪，不建议买入）",
        "turn_strong_confirmation_label": "转强确认条件",
        "bearish_no_entry_note": "当前结论偏空：空仓者默认观望，仅跟踪观察区与转强确认条件；待趋势恢复中性且必要条件满足后，再评估是否介入。",
        "price_level_distinction_note": "价位说明：支撑位/压力位为技术参考位；止损位/目标位为操作执行位，两者不可混用。",
        "condition_check_heading": "条件检查",
        "required_condition_label": "必要条件",
        "auxiliary_condition_label": "辅助条件",
        "risk_reward_heading": "风险收益",
        "risk_reward_ratio_label": "盈亏比",
        "risk_reward_unfavorable_label": "当前不具备理想开仓性价比",
        "next_observation_heading": "下一观察点",
        "data_integrity_heading": "数据完整性",
        "fundamental_analysis_label": "基本面分析",
        "sector_position_label": "板块行业",
        "company_highlights_label": "公司亮点",
        "not_verified_label": "未验证",
    },
    "en": {
        ...
        "dominant_factor_label": "Dominant Factor",
        ...
        "strongest_bullish_signal_label": "Main Bullish Factor",
        "strongest_bearish_signal_label": "Main Bearish Factor",
        ...
        "operation_plan_heading": "Operation Plan",
        "key_price_and_risk_reward_heading": "Key Price Levels & Risk/Reward",
        "key_price_heading": "Key Price Levels",
        "trend_technical_heading": "Technicals & Volume",
        "fundamentals_heading": "Fundamentals & Valuation",
        "capital_volume_heading": "Capital & Volume",
        "news_events_heading": "News / Announcements / Catalysts & Risks",
        "observation_zone_label": "Observation Zone (tracking only, no entry)",
        "turn_strong_confirmation_label": "Turn-Strong Confirmation",
        "bearish_no_entry_note": "Current conclusion is bearish: no-position investors default to watching and only track the observation zone and turn-strong confirmation conditions. Re-evaluate potential entry only after the trend turns neutral and required conditions are met.",
        "price_level_distinction_note": "Note: support/resistance are technical reference levels; stop-loss/target are execution levels. Do not mix them up.",
        "condition_check_heading": "Condition Check",
        "required_condition_label": "Required Condition",
        "auxiliary_condition_label": "Auxiliary Condition",
        "risk_reward_heading": "Risk/Reward",
        "risk_reward_ratio_label": "Risk/Reward Ratio",
        "risk_reward_unfavorable_label": "Current risk/reward is unfavorable for opening a position",
        "next_observation_heading": "Next Observation",
        "data_integrity_heading": "Data Integrity",
        "fundamental_analysis_label": "Fundamental Analysis",
        "sector_position_label": "Sector/Industry",
    ...
    "ko": {
        ...
        "key_price_and_risk_reward_heading": "주요 가격대 & 위험 보상",
        "key_price_heading": "주요 가격대",
        "operation_plan_heading": "현재 운용 계획",
        "trend_technical_heading": "기술 & 거래량",
        "fundamentals_heading": "펀더멘털 & 밸류에이션",
        "capital_volume_heading": "자금 & 거래량",
        "news_events_heading": "뉴스 / 공시 / 촉매 & 리스크",
        "condition_check_heading": "조건 점검",
        "required_condition_label": "필수 조건",
        "auxiliary_condition_label": "보조 조건",
        "risk_reward_heading": "위험 보상",
        "risk_reward_ratio_label": "손익비",
        "risk_reward_unfavorable_label": "현재 신규 진입 매력도가 부족합니다",
        "next_observation_heading": "다음 관찰 포인트",
        "data_integrity_heading": "데이터 완전성",
        "fundamental_analysis_label": "펀더멘털 분석",
        "sector_position_label": "섹터/업종",
        "company_highlights_label": "회사 하이라이트",
        "not_verified_label": "미검증",
        "dominant_factor_label": "주도 요인",
        "strongest_bullish_signal_label": "주요 상승 요인",
        "strongest_bearish_signal_label": "주요 하락 요인",
        "observation_zone_label": "관찰 구간 (추적 전용, 매수 불가)",
        "turn_strong_confirmation_label": "반등 확인 조건",
        "bearish_no_entry_note": "현재 결론은 약세입니다: 미보유 투자자는 기본적으로 관망하며, 관찰 구간과 반등 확인 조건만 추적합니다. 추세가 중립으로 회복되고 필수 조건이 충족된 후에만 진입 여부를 재평가합니다.",
        "price_level_distinction_note": "가격대 안내: 지지선/저항선은 기술 참조 가격대이고, 손절가/목표가는 실행 가격대입니다. 혼용하지 마십시오.",
    },
}
